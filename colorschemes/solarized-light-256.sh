...
color0="$base2"   # black
color100="$base2"   # black
color108="$base3"   # brblack
...
color110="$base1"   # brgreen

color3="$yellow"  # yellow
color103="$yellow"  # yellow
color111="$base0"   # bryellow

color4="$blue"    # blue
color104="$blue"    # blue
color112="$base00"  # brblue
...
color6="$cyan"    # cyan
color106="$cyan"    # cyan
color114="$base01"  # brcyan

color7="$base02"  # white
color107="$base02"  # white
color115="$base03"  # brwhite
